...
//
// USAGE:
//   node scripts/workflow-guard-mutation-check.mjs            # gate: non-baselined guards must be COVERED
//   node scripts/workflow-guard-mutation-check.mjs --all      # measure every guard, report only, exit 0
//   node scripts/workflow-guard-mutation-check.mjs --list     # enumerate the guards and exit
//   node scripts/workflow-guard-mutation-check.mjs --seed     # record every currently-UNCOVERED guard
