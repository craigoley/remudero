...
export const ENV_REGISTRY: readonly EnvRegistryEntry[] = [
  ...
  envEntry("RMD_CASH_METRICS_RESOURCE_ID", "Names the Azure ARM resource whose Monitor metrics are read for what the cash lane actually billed; absent means the reading is unavailable, never guessed.", ["src/lib/cash-actuals.ts"]),
