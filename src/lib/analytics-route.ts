...
export interface AnalyticsSnapshot {
  ...
  /** W1-T3762: bounded routing policy/receipt attribution for the operator console. */
...
function accumulateAnalyticsLine(acc: AnalyticsAccumulator, line: Record<string, unknown>): void {
  // W1-T3762: assignment/terminal attribution is folded from this SAME union pass. It has its
