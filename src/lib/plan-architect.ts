...
//
// W1-T2895: `isInPlanScope`/`outOfPlanScopeFiles`/`ORIENTATION_DOC` moved to the leaf module
// `plan-scope.ts` — this was the `review.ts` -> `plan-architect.ts` -> `plan-pr-emitter.ts` ->
