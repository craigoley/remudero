...
/** W1-T2971 widened this from the single `"fix-dispatch"` literal: the registry was always a
...
/** W1-T2971 — is an action of this kind already detached? A second concurrent retro would race the
