# Forensics — `src/lib/sweep.ts`

A verbatim archive of comment blocks compacted out of `src/lib/sweep.ts`. Each heading names
...
Line numbers below are the block's first line in `src/lib/sweep.ts` at the merge base.

## module header — lib/sweep.ts

Archived from `src/lib/sweep.ts` lines 46-189 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 202-220 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 222-229 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 237-243 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 254-262 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 271-278 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 280-287 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 289-300 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 392-406 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 414-420 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 432-439 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 444-464 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 475-485 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 503-524 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 533-538 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 550-556 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 577-583 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 585-610 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 612-638 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 644-660 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 662-672 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 674-684 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 692-705 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 707-721 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 723-731 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 736-745 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 747-776 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 778-825 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 827-876 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 878-905 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 909-954 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 957-971 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1120-1128 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1147-1154 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1156-1169 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1178-1200 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1202-1208 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1210-1226 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1228-1257 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1263-1291 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1295-1308 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1322-1348 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1350-1374 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1378-1385 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1387-1394 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1398-1410 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1418-1427 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1450-1468 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1470-1493 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1495-1511 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1513-1519 at the merge base.
...
## OpenPrView.reviewOrphanedByPush

Archived from `src/lib/sweep.ts` lines 1521-1539 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1541-1548 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1567-1573 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1589-1600 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1603-1618 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1629-1649 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1660-1707 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1716-1719 at the merge base.
...
## checksStateFromRollup — the one ok-set

Archived from `src/lib/sweep.ts` lines 1726-1747 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1758-1767 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1777-1795 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1799-1818 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1823-1852 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1871-1904 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1921-1944 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1966-1976 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 1995-2001 at the merge base.
...
## main health section — W1-T2204

Archived from `src/lib/sweep.ts` lines 2012-2033 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 2035-2043 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 2046-2060 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 2078-2090 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 2180-2190 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 2202-2209 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 2224-2235 at the merge base.
...
## CI_GATE_CHECK_NAME — the re-aggregation section

Archived from `src/lib/sweep.ts` lines 2240-2255 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 2258-2286 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 2294-2303 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 2313-2330 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 2352-2355 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 2366-2373 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 2390-2397 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 2415-2450 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 2455-2481 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 2492-2510 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 2515-2537 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 2540-2545 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 2553-2565 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 2579-2594 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 2600-2611 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 2638-2645 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 2650-2656 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 2666-2676 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 2689-2704 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 2776-2803 at the merge base.
...
## absentChecksRepushDecision and absentAgeMinutes

Archived from `src/lib/sweep.ts` lines 2843-2896 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 2991-3002 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 3042-3049 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 3052-3058 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 3063-3094 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 3103-3111 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 3120-3136 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 3142-3165 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 3173-3191 at the merge base.
...
## DISPOSITION_RULES — the full ordered table

Archived from `src/lib/sweep.ts` lines 3201-3374 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 3377-3387 at the merge base.
...
## disposition (lines 3403-3411)

Archived from `src/lib/sweep.ts` lines 3403-3411 at the merge base.
...
## disposition (lines 3426-3432)

Archived from `src/lib/sweep.ts` lines 3426-3432 at the merge base.
...
## disposition (lines 3438-3444)

Archived from `src/lib/sweep.ts` lines 3438-3444 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 3453-3457 at the merge base.
...
## DISPOSITION_RULES row 3.5 — verdict overtaken by activity

Archived from `src/lib/sweep.ts` lines 3464-3493 at the merge base.
...
## disposition (lines 3509-3516)

Archived from `src/lib/sweep.ts` lines 3509-3516 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 3536-3543 at the merge base.
...
## disposition (lines 3552-3559)

Archived from `src/lib/sweep.ts` lines 3552-3559 at the merge base.
...
## disposition (lines 3568-3576)

Archived from `src/lib/sweep.ts` lines 3568-3576 at the merge base.
...
## disposition (lines 3584-3597)

Archived from `src/lib/sweep.ts` lines 3584-3597 at the merge base.
...
## disposition (lines 3613-3619)

Archived from `src/lib/sweep.ts` lines 3613-3619 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 3625-3628 at the merge base.
...
## DISPOSITION_RULES row 7.5 — the conflicted arm

Archived from `src/lib/sweep.ts` lines 3638-3663 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 3668-3671 at the merge base.
...
## disposition (lines 3691-3704)

Archived from `src/lib/sweep.ts` lines 3691-3704 at the merge base.
...
## disposition (lines 3717-3724)

Archived from `src/lib/sweep.ts` lines 3717-3724 at the merge base.
...
## disposition (lines 3739-3742)

Archived from `src/lib/sweep.ts` lines 3739-3742 at the merge base.
...
## disposition (lines 3748-3757)

Archived from `src/lib/sweep.ts` lines 3748-3757 at the merge base.
...
## disposition (lines 3769-3783)

Archived from `src/lib/sweep.ts` lines 3769-3783 at the merge base.
...
## DISPOSITION_RULES row 8.5 — post-review routing

Archived from `src/lib/sweep.ts` lines 3798-3832 at the merge base.
...
## disposition (lines 3859-3866)

Archived from `src/lib/sweep.ts` lines 3859-3866 at the merge base.
...
## DISPOSITION_RULES row 8.7 — stalled by a terminal run

Archived from `src/lib/sweep.ts` lines 3878-3898 at the merge base.
...
## disposition (lines 3906-3913)

Archived from `src/lib/sweep.ts` lines 3906-3913 at the merge base.
...
## disposition (lines 3924-3929)

Archived from `src/lib/sweep.ts` lines 3924-3929 at the merge base.
...
## DISPOSITION_RULES — the not-yet-scheduled row

Archived from `src/lib/sweep.ts` lines 3940-3967 at the merge base.
...
## disposition (lines 3979-3987)

Archived from `src/lib/sweep.ts` lines 3979-3987 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 3995-4017 at the merge base.
...
## clockSkewSuppressedStale

Archived from `src/lib/sweep.ts` lines 4036-4040 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4053-4078 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4089-4139 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4143-4151 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4178-4187 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4190-4221 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4237-4263 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4271-4274 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4296-4300 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4306-4344 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4368-4381 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4383-4387 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4393-4409 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4423-4427 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4444-4448 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4452-4460 at the merge base.
...
## observedState (lines 4511-4515)

Archived from `src/lib/sweep.ts` lines 4511-4515 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4534-4540 at the merge base.
...
## the repeat-disposition counter section

Archived from `src/lib/sweep.ts` lines 4551-4559 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4574-4614 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4635-4647 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4687-4696 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4701-4713 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4726-4743 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4758-4783 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4806-4824 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4834-4851 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4857-4862 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4870-4874 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4886-4888 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4890-4892 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4895-4901 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4904-4912 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4918-4936 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4944-4952 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4960-4978 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 4982-4996 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5000-5008 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5010-5029 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5031-5035 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5041-5052 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5054-5070 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5075-5080 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5082-5090 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5092-5099 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5101-5113 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5115-5125 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5127-5137 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5145-5163 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5165-5184 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5187-5203 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5205-5210 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5212-5220 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5222-5227 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5229-5238 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5240-5248 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5250-5262 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5264-5279 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5298-5315 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5317-5324 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5339-5344 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5346-5361 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5373-5379 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5395-5404 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5408-5423 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5425-5446 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5455-5472 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5474-5480 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5484-5487 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5504-5516 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5518-5520 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5538-5562 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5569-5578 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5649-5652 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5655-5658 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5725-5779 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5801-5811 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5813-5818 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5844-5847 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5851-5881 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5897-5901 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5910-5914 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5952-5958 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 5986-6009 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6012-6050 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6053-6069 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6116-6131 at the merge base.
...
## detachedSweepActions

Archived from `src/lib/sweep.ts` lines 6151-6178 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6181-6187 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6197-6203 at the merge base.
...
## runSweep and orderPendingReviews

Archived from `src/lib/sweep.ts` lines 6216-6268 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6325-6328 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6340-6343 at the merge base.
...
## baseCausedReleaseTarget

Archived from `src/lib/sweep.ts` lines 6345-6348 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6379-6390 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6403-6407 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6409-6412 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6423-6435 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6438-6450 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6490-6502 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6514-6517 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6548-6551 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6555-6567 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6583-6586 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6615-6619 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6623-6627 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6629-6632 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6647-6651 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6654-6659 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6661-6664 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6667-6670 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6674-6677 at the merge base.
...
## the per-pass heartbeat row

Archived from `src/lib/sweep.ts` lines 6685-6716 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6725-6730 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6738-6741 at the merge base.
...
## sweep.repeat_escalated — the ledger row is the output

Archived from `src/lib/sweep.ts` lines 6744-6756 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6760-6764 at the merge base.
...
## unattributableFiling

Archived from `src/lib/sweep.ts` lines 6770-6778 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6781-6785 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6793-6796 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6798-6803 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6807-6819 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6824-6829 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6835-6841 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6847-6850 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6864-6872 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6883-6887 at the merge base.
...
## reviewKey (lines 6919-6929)

Archived from `src/lib/sweep.ts` lines 6919-6929 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6935-6943 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6956-6961 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6963-6968 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6975-6978 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6988-6994 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 6996-7001 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7003-7006 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7008-7011 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7013-7017 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7019-7022 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7026-7035 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7046-7052 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7063-7066 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7068-7071 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7078-7086 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7096-7101 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7108-7112 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7121-7126 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7131-7140 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7146-7150 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7158-7161 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7172-7184 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7192-7195 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7216-7220 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7227-7231 at the merge base.
...
## appendLine (lines 7236-7240)

Archived from `src/lib/sweep.ts` lines 7236-7240 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7261-7269 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7277-7293 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7297-7300 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7334-7340 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7363-7368 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7441-7446 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7454-7457 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7460-7466 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7484-7489 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7517-7523 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7533-7539 at the merge base.
...
## appendLine (lines 7545-7551)

Archived from `src/lib/sweep.ts` lines 7545-7551 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7566-7573 at the merge base.
...
## reviewKey (lines 7600-7603)

Archived from `src/lib/sweep.ts` lines 7600-7603 at the merge base.
...
## the review lane's concurrency budget wiring

Archived from `src/lib/sweep.ts` lines 7626-7647 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7667-7673 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7717-7737 at the merge base.
...
## appendLine (lines 7756-7762)

Archived from `src/lib/sweep.ts` lines 7756-7762 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7783-7793 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7812-7816 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7828-7831 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7864-7869 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7882-7886 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7934-7941 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 7959-7999 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8006-8009 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8011-8018 at the merge base.
...
## outcomeDedupedNumbers

Archived from `src/lib/sweep.ts` lines 8034-8037 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8061-8064 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8110-8143 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8152-8179 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8187-8190 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8230-8256 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8263-8272 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8280-8296 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8327-8346 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8358-8366 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8378-8384 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8400-8416 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8418-8440 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8485-8491 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8497-8503 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8519-8535 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8547-8553 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8569-8592 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8606-8625 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8637-8653 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8670-8680 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8693-8699 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8701-8707 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8716-8727 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8751-8765 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8767-8777 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8803-8820 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8822-8839 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8847-8853 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8879-8884 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8889-8896 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8915-8932 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8938-8947 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8950-8959 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 8975-8982 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 9024-9028 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 9032-9036 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 9053-9068 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 9088-9094 at the merge base.
...
## intake (lines 9174-9180)

Archived from `src/lib/sweep.ts` lines 9174-9180 at the merge base.
...
## the post-fix re-verification reconciler section

Archived from `src/lib/sweep.ts` lines 9196-9240 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 9242-9250 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 9262-9270 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 9283-9291 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 9304-9311 at the merge base.
...
## DIFF_COVERAGE_BLOCK_RE

Archived from `src/lib/sweep.ts` lines 9324-9331 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 9343-9358 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 9378-9387 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 9396-9401 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 9410-9425 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 9449-9464 at the merge base.
...
## readLedger (lines 9471-9474)

Archived from `src/lib/sweep.ts` lines 9471-9474 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 9484-9490 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 9507-9510 at the merge base.
...
Archived from `src/lib/sweep.ts` lines 9528-9531 at the merge base.
