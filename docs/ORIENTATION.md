...
_MAINTAINED BY `rmd retro` — regenerated 2026-09-14T09:07:56.244Z. Hand edits are overwritten on the next retro; change MASTER-PLAN.md or plan/tasks.yaml instead, never this file directly._
...
40 run(s) since the last retro marker. Verdicts: {"blocked_ci":3,"incomplete":30,"merged":6,"no_pr":1}.

### Shipped since marker
- RETRO → https://github.com/craigoley/remudero/pull/5504 (gate-side merge; run ended incomplete)
- TRIAGE-fb-1789331541509-6463e8 → https://github.com/craigoley/remudero/pull/5492 (gate-side merge; run ended incomplete)
- TRIAGE-fb-1789349833277-20ca42 → https://github.com/craigoley/remudero/pull/5494 (gate-side merge; run ended incomplete)
