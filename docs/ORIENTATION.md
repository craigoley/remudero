...
_MAINTAINED BY `rmd retro` — regenerated 2026-09-24T08:58:31.955Z. Hand edits are overwritten on the next retro; change MASTER-PLAN.md or plan/tasks.yaml instead, never this file directly._
...
16 run(s) since the last retro marker. Verdicts: {"blocked_transient":1,"incomplete":12,"merged":3}.

### Shipped since marker
- RETRO → https://github.com/craigoley/remudero/pull/6963 (gate-side merge; run ended incomplete)
