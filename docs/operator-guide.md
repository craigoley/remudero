...
| `rmd audit <fixture>` | Grade a written audit against a checked-in fixture and print the finding diff — the T2 monthly rung `docs/audits/README.md` names. Read-only: it reports, it never writes the audit. |
