...
const BASELINE_COMMAND_NAMES = [
  "alert-fix", "approve", "audit", "authority", "autonomy-rate", "away", "bundle", "caller-sweep", "check-acceptance", "check-proof",
...
// W1-T2924: `audit` — grades a deterministic source gather against a frozen recon fixture's
// finding table, the T2 monthly rung docs/audits/README.md names — joins the registry.
