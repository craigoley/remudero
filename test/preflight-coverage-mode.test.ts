...
test("FAST_GATE_STEPS: unaffected by --coverage's existence — still exactly the eight deterministic npm-script gates (the seven pre-existing plus W1-T2488's source-size-ratchet) plus the four W1-T2478 census entries, no coverage-shaped entry added", () => {
