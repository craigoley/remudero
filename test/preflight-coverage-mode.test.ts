...
test("FAST_GATE_STEPS: unaffected by --coverage's existence — still exactly the nine deterministic npm-script gates, including W1-T2734's source-size signal, plus the four W1-T2478 census entries", () => {
