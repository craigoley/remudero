...
test("W1-T3141: git exits 128 for a MISSING REF exactly as for a MISSING PATH — the premise, measured, not restated", () => {
...
test("W1-T3141: an unresolvable ref leaves every violation UNDETERMINED, and blames none of them on this diff", () => {
...
test("W1-T3141: the predicate is LOAD-BEARING — the identical inputs without it still read as introduced", () => {
...
test("W1-T3141: the SHIPPED ratchet, run where origin/main does not resolve, says so instead of printing nothing", () => {
...
test("W1-T3141: the source-size job checks out deeply enough for origin/main, with exactly one checkout step", () => {
