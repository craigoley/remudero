...
const DETACHED_FIX_SWEEP_NOW_MS = Date.parse("2026-09-05T04:40:00Z");
...
function blockedPr(): OpenPrView {
  return {
    ...
    priorStrikes: 0,
    lastActivityAt: new Date(DETACHED_FIX_SWEEP_NOW_MS - 40 * 60 * 1000).toISOString(),
