...
test("FAST_GATE_STEPS: the curated list is exactly the ten deterministic npm-script gates, including W1-T2734's source-size signal and the comment-load ratchet, plus the seven census entries (four from W1-T2478, W1-T2695's authority-census, W1-T2898's ledger-literal-census, and W1-T3387's self-path-proof census)", () => {
