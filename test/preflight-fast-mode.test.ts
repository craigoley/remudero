...
test("FAST_GATE_STEPS: the curated list is exactly the ten deterministic npm-script gates, including W1-T2734's source-size signal and the comment-load ratchet, plus the five census entries (four from W1-T2478, plus W1-T2695's authority-census)", () => {
