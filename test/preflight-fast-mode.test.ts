...
test("FAST_GATE_STEPS: the curated list is exactly the eight deterministic npm-script gates (the seven the task names plus W1-T2488's source-size-ratchet) plus the four W1-T2478 census entries — the required core, the same-class rest, and the census class", () => {
