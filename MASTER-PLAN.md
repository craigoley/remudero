...
- followup:DAEMON-1789306309171:2026-09-13T13:53:53.493Z:0 (test/credential-reach-probe.test.ts and test/emissions.test.ts fail locally in a worker's sandboxed checkout — emissions.test.ts's failure is ALREADY DECIDED via queued W1-T2951, not re-filed; credential-reach-probe.test.ts's failure is a REAL, live-reproduced gap: ungoverned:operator-claude-json and ungoverned:operator-credentials are both reachable on this exact host class right now, and the latter is reachable because the merged W1-T505 `.claude-fleet` narrowing has never been activated on either fleet host, per W1-T971's own recorded finding) — RATIFIED 2026-09-13 -> W1-T4348/W1-T4349.
