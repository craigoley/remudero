...
- skill-draft:a4ce515f0f097a31 (a procedure shape proven across 78 merged implement runs — resolve on the first attempt, no `fix.dispatch` rung needed; staged by skill-workshop.ts/W1-T2766, staged text says "not reachable" only via the still-open native settingSources loader (W1-T3137), but the separately merged W1-T3101 harness-side injection pathway already reads `.claude/skills/` directly and is waiting for exactly this file) — RATIFIED 2026-09-11 -> W1-T4337.
