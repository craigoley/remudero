...
- codeql-quality:js/useless-assignment-to-local (3 open CodeQL quality alerts for js/useless-assignment-to-local — #116, #125, #145 — get one bounded, evidence-first cleanup task that reads each alert from the API before touching code and never auto-fixes or hand-dismisses) — RATIFIED 2026-09-15 -> W1-T4333.
