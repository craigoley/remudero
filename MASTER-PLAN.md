...
- skill-draft:25c3724cf6958acf (implement-clean-single-strike) — RATIFIED 2026-09-11 -> W1-T4282/W1-T4283. The drafted SKILL.md is NOT written as proposed: its reachability note is stale against the shipped W1-T3101 injection route (W1-T4282), and its sole procedure step restates the mined outcome rather than naming a behavior (W1-T4283) — both fixed before any clean_single_strike-shaped draft is re-offered for approval.
