...
- skill-draft:de866b8a3997b473 (the mined clean_single_strike procedure for implement tasks, 82 supporting merged runs; the proposal's own "NOT reachable by a worker today" line measures the SDK-native settingSources route W1-T3101 deliberately refused to touch, not the already-live W1-T3101 injection route this draft's applies-to: implement frontmatter already qualifies for -- ratified with an end-to-end reachability proof against the real .claude/skills tree, plus a companion fix to the reachability signal every future skill-draft proposal reuses) — RATIFIED 2026-09-11 -> W1-T4340/W1-T4341.
