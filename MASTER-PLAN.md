...
- proof-debt:W1-T3591 (W1-T3591's own grep-path-absent criterion names learnings/ci-gate-lessons.yaml, a remedy file the ci-learning rung has never written for any of its six pending findings — create the file and land the one entry this proposal's finding needs) — RATIFIED 2026-09-15 -> W1-T4281.
