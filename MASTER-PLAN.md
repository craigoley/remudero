...
- P77 (the ci-learning shard producer's grep-proof target, learnings/ci-gate-lessons.yaml, exists on disk nowhere and is indexed by learnings/index.json nowhere, so W1-T3589 and five siblings W1-T3590-T3594 carry a permanently-unresolvable proof-debt; repoint the producer and the six already-filed victims to the indexed learnings/ci.yaml) — RATIFIED 2026-09-15 -> W1-T4288/W1-T4289.
